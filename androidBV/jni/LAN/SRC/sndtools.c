...
//         printf("playbuf.timestamp[playbuf.iget/AUDIOBLK] =%d\n",playbuf.timestamp[playbuf.iget/AUDIOBLK]);
			...
			dwSize = play_pcm((char *) (playbuf.buffer + playbuf.iget), AUDIOBLK);
#ifdef _RECORD_PCM_FILE
