...
public:
    ...
    /* Set the HDMI cable status
     * status
     * 1 : HDMI cable is inserted
     * 0 : HDMI cable is not inserted
     */
    virtual void setHdmiStatus(uint32_t status) = 0;
    virtual void setHdmiMode(uint32_t mode) = 0;
    virtual void setHdmiResolution(uint32_t resolution) = 0;
    virtual void setHdmiHdcp(uint32_t hdcp_en) = 0;
    virtual void blit2Hdmi(int32_t w, int32_t h,
                           int32_t colorFormat,
                           int32_t hdmiLayer,
                           uint32_t physYAddr,
                           uint32_t physCbAddr) = 0;
#endif
};
