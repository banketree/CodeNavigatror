...
typedef void (*OutgoingHintMusicDone)(struct _LinphoneCore *lc, LinphoneCall *call);
typedef void (*CallFailureCb)(struct _LinphoneCore *lc, LinphoneCall *call, SalError error, SalReason sr, int code);
//typedef void (*CallIncommingReceivcedCb)(int type);
typedef void (*RegStatusCb)(struct _LinphoneCore *lc, bool_t status, int code);
//--------------------------------------------------------------------------------
...
//    CallEncryptionChangedCb call_encryption_changed; /**<Notifies on change in the encryption of call streams */
    CallFailureCb notify_call_failure;
//    CallIncommingReceivcedCb notify_call_incomming;

    OutgoingHintMusicDone outgoing_hint_music_done;
...
int linphone_core_set_sip_transports(LinphoneCore *lc, LCSipTransports *transports);
