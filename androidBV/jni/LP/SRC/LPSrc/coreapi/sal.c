...
//SalStreamDescription *sal_media_description_test(SalMediaDescription *md,
...
//NULL==sal_media_description_find_stream(pstLpCall->op->result, SalProtoRtpAvp, SalVideo)
