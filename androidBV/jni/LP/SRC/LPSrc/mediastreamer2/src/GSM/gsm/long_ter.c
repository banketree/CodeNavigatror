...
/* $Header: n:\\development/speak_freely/GSM/LONG_TER.C,v 1.1.1.1 1998/10/15 00:47:39 Administrator Exp $ */
...
# else
#				define STEP(k) (wt[k] * (longword) dp[k - lambda])
# endif
...
#				define	STEP_H(K)		STEP(K, h, a, b, c, d, e, f, g)
				...
				if (S0 > L_max) { L_max = S0; Nc = (word) lambda;	   }
