/*! \mainpage GM8126 dvr encode ioctl functions
 *
 ...
 *
 * \arg explanation : get buffer from user space, and release buffer at videograph level
 * \arg parameter :
 * \n \b \e pointer \b \e data : argument from user space ioctl parameter, it means structure dvr_enc_queue_get
 */
 ...
 *
 * \arg explanation : get encode contorl command from user space, and set command to videograph level
 * \arg parameter :
