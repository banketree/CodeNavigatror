...
//add by chensq 20120911 for g729
//#include "mscodecutils.h"
...
#ifdef _YK_XT8126_
extern MSSndCardDesc YK8126AudioCardDesc;
//#elif _YK_IMX27_AV_
//extern MSSndCardDesc Imx27AudioCardDesc;
#else
//extern MSSndCardDesc oss_card_desc;
#endif
...
#endif
#ifdef ANDROID
//extern MSWebCamDesc ms_android_fimc_video_capture_desc;  
//extern MSWebCamDesc ms_stragefright_video_capture_desc;
...
#endif
#if defined (ANDROID)
	//&ms_android_fimc_video_capture_desc,
	&ms_android_video_capture_desc,
	//&ms_stragefright_video_capture_desc,
#endif
#else
	&V8126WebCamDesc,
#endif
...
//	ms_message("ortp_set_log_handler...");
//	ortp_set_log_level_mask(ORTP_MESSAGE|ORTP_WARNING|ORTP_ERROR|ORTP_FATAL);
//	ortp_set_log_handler(ms_message);
...
//src->new
#define DEFAULT_MAX_PAYLOAD_SIZE 1360
...
////============================================================
////add by chensq for g729 20120911
//
