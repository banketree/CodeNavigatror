...
//modify by chensq  src:ORTP_WARNING | ORTP_ERROR | ORTP_FATAL;
unsigned int __ortp_log_mask=ORTP_WARNING | ORTP_ERROR | ORTP_FATAL;


int ortp_get_log_level_mask(void){
	printf("ortp_set_log_level_mask current levelmask=%d\n", __ortp_log_mask);
...
void ortp_set_log_level_mask(int levelmask){
	printf("ortp_set_log_level_mask old levelmask=%d\n", __ortp_log_mask);
	__ortp_log_mask=levelmask;
	printf("ortp_set_log_level_mask new levelmask=%d\n", __ortp_log_mask);
}
