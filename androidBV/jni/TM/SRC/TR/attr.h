// $Id: attr.h 12 2011-02-18 04:05:43Z cedric.shih@gmail.com $
/*
...
int evcpe_attr_del_obj2(struct evcpe_attr *attr, unsigned int index);
...
int evcpe_value_to_param_value_list(struct evcpe_param_value_list *list, 
