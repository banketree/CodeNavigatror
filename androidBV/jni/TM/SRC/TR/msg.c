// $Id: msg.c 12 2011-02-18 04:05:43Z cedric.shih@gmail.com $
/*
	...
	if (msg->data) {
		...
		case EVCPE_MSG_REQUEST:
			...
			case EVCPE_INFORM:
				...
				break;
			case EVCPE_REBOOT:
				evcpe_reboot_free(msg->data);
				break;
			case EVCPE_UPLOAD:
				evcpe_upload_free(msg->data);
				break;
			case EVCPE_DOWNLOAD:
				evcpe_download_free(msg->data);
				break;
			case EVCPE_TRANSFER_COMPLETE:
				evcpe_transfercomplete_free(msg->data);
				break;
			default:
		...
		case EVCPE_MSG_RESPONSE:
			...
			case EVCPE_INFORM:
				...
				break;
			case EVCPE_REBOOT:
				evcpe_reboot_response_free(msg->data);
				break;
			case EVCPE_UPLOAD:
				evcpe_upload_response_free(msg->data);
				break;
			case EVCPE_DOWNLOAD:
				evcpe_download_response_free(msg->data);
				break;
			case EVCPE_TRANSFER_COMPLETE:
				evcpe_transfercomplete_response_free(msg->data);
				break;
			default:
